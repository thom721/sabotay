...
/// Formulaire de changement de mot de passe, partagé entre le flux forcé et
/// le changement volontaire côté portail Client — seul le callback
/// `onSubmit` diffère selon l'identité (Utilisateur ou Client).
