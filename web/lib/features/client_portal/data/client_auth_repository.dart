...
/// backend (`backend/app/api/v1/endpoints/client_auth.py`), déjà branchés
/// côté mobile. Contrairement à `AuthRepository.login` (formulaire OAuth2),
/// `/auth/client-login` attend du JSON.
