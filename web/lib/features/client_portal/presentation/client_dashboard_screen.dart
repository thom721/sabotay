...
/// Accueil du portail Client : solde, jours restants, jours manqués,
/// aperçu de l'historique. Lecture seule.
class ClientDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ClientPortalShell(
      title: 'Mon compte Sabotay',
      currentRoute: '/client/accueil',
            ...
            children: [
              if (comptes.length > 1) ...[
                ConstrainedBox(
                  ...
                  child: _CompteSelecteur(comptes: comptes, selectedId: compte.id),
                ),
