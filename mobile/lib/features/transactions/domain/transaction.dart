...
/// Rapport de collecte sur une période (PRD §8.7) — un Agent ne reçoit que
/// ses propres collectes, Admin/Manager reçoivent tout le tenant (filtrage
/// déjà appliqué côté backend, GET /transactions/rapport).
class Rapport {
