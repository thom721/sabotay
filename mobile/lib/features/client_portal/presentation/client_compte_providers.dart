...
final clientCompteSoldeProvider = FutureProvider.family<CompteSolde, String>((ref, compteId) {
  return ref.watch(clientCompteRepositoryProvider).getSolde(compteId);
});

final clientTransactionsProvider = FutureProvider.family((ref, String compteId) {
...
final clientCompteSelectionneProvider = StateProvider<String?>((ref) => null);
